	  <div class="col-sm-4 left-col" id="">
        ...
        <div class="slide-tab" id="form-addfield-tab" data-target="#form-review"><i class="glyphicon glyphicon-collapse-down icon"></i>Click to add</div>
...
<a style="width:99.5%;text-align:left;" data-type="element-section-break" class="field-button new-element element-section-break">Section Break<div class="menu-line"></div></a>
<a style="width:49%; float:left; margin-right:3px;" data-type="element-single-line-text" id="draggable2" class="field-button new-element element-single-line-text margin"><i class="glyphicon glyphicon-font icon "></i>Single Line Text</a>
<a style="width:49%; float:left; margin-right:0px;" data-type="element-paragraph-text" id="draggable2" class="field-button new-element element-paragraph-text margin"><i class="glyphicon glyphicon-pencil icon "></i>Paragraph</a>
<a style="width:99.5%;float:left;" data-type="element-checkboxes" class="field-button new-element element-checkboxes margin">
<i class="glyphicon glyphicon-unchecked icon small"></i><i class="glyphicon glyphicon-check icon small"></i>Checkboxes</a>
<a style="width:49%; float:left; margin-right:3px;" data-type="element-multiple-choice" class="field-button new-element element-multiple-choice margin"><i class="glyphicon glyphicon-record icon"></i>Multiple Choice</a>
<a style="width:49%; float:left; margin-right:0px;" data-type="element-dropdown" class="field-button new-element element-dropdown"><i class="glyphicon glyphicon-chevron-down icon"></i>Dropdown</a>
<a style="width:49%; float:left; margin-right:3px;" data-type="element-number" class="field-button new-element element-number"><i class="glyphicon glyphicon-th icon"></i>Number</a>
<a style="width:49%; float:left; margin-right:0px;" data-type="element-email" class="field-button new-element element-email"><i class="glyphicon glyphicon-calendar icon"></i>Date</a>
<!--  <button class="button new-element" data-type="element-email" style="width: 100%;">Email</button> -->
          ...
          <div class="slide-tab" id="form-review-tab" data-target="#form-review"><i class="glyphicon glyphicon-collapse-up icon"></i>Review of Systems</div>
...
<div class="tab-pane" id="form-review" style="padding: 20px; display: none;visibility:visible;">
           ...
           <div style="width:80%;" class="slide-tab" id="form-settings-tab" data-target="#form-settings"><i class="glyphicon glyphicon-collapse-up icon"></i>Form Settings</div>
      ...
      <div class="col-sm-8 right-col" id="form-col">
...
<script>
$("#form-review-tab").click(function(){
    $("#form-review").slideToggle();
    $("#add-field").slideUp();
    $("#form-settings").slideUp();
    $("i", this).toggleClass("glyphicon glyphicon-collapse-up icon glyphicon glyphicon-collapse-down icon");
    $("#form-addfield-tab i").attr('class', 'glyphicon glyphicon-collapse-down icon');
    $("#form-settings-tab i").attr('class', 'glyphicon glyphicon-collapse-down icon');
});
$("#form-settings-tab").click(function(){
    $("#form-settings").slideToggle();
    $("#add-field").slideUp();
    $("#form-review").slideUp();
    $("i", this).toggleClass("glyphicon glyphicon-collapse-up icon glyphicon glyphicon-collapse-down icon");
    $("#form-addfield-tab i").attr('class', 'glyphicon glyphicon-collapse-down icon');
    $("#form-review-tab i").attr('class', 'glyphicon glyphicon-collapse-down icon');
});
$("#form-addfield-tab").click(function(){
