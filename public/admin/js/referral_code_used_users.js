...
if(action=='page_referral_code_used_users'){
	getreferralcodeuseduserslist(1);
}

function getreferralcodeuseduserslist(pageno){
	...
	$.ajax({
		type: "post",
		url: base_url+'/getreferralcodeuseduserslist',
