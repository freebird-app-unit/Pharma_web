...
function getuserlist(pageno){
	...
	$.ajax({
			type: "post",
			url: base_url+'/getsellerlist',
			data: 'pageno='+pageno+"&perpage="+perpage+"&_token="+token+"&searchtxt="+searchtxt+"&ord_field="+ord_field+"&sortord="+sortord+"&search_pharmacy="+search_pharmacy,
...
$(document).on('click', '.deleteUser', function () {
	...
	swal({
		...
		$.ajax({
			...
			url: base_url +'/seller/delete/' + CategoryId,
			type: "GET",
