...
<div class="row">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item">
			<a href="{{ route('adminoutfordelivery.index') }}" class="nav-link active">Out For Delivery</a>
		</li>
		<li class="nav-item">
			<a href="{{ route('adminpickup.index') }}" class="nav-link">Ready For Pickup</a>
		</li>
	</ul>
</div>
<div class="row">
				...
				<div class="table-responsive" data-pattern="priority-columns">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<button class="btn btn-info" onclick="return getoutfordeliverylist(1);">Filter</button>
						</div><!-- input-group -->
					</div>
