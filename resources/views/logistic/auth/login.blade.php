...
<div class=" card-box" style="padding:0;">
	<div class="panel-body" style="padding:0 15px;">
		<div class="row">
			<div class="col-sm-3">
				<h1 align="center">Logistic Login</h1>
				...
				@endif
				<form method="POST" action="{{ route('logistic_logins') }}" class="form-horizontal m-t-20" style="padding:80px 0;">
				@csrf
			...
			<?php $image = url('/').'/public/images/c_login.png' ?>
