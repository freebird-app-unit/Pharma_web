			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div style="text-align:center;">
						...
						<a href="javascript:;" class="btn btn-info">Assiging...</a>
					</div>
					<br><br>
					<div>
						...
						Delivery Type:&nbsp;&nbsp;<?php echo $order->delivery_type; ?><br><br>
						Order Amount:&nbsp;&nbsp;<?php echo $order->order_amount; ?><br><br>
						Delivery Amount:&nbsp;&nbsp;<?php echo $order_detail->deliveryprice; ?><br><br>
						Net payable Amount:&nbsp;&nbsp;<?php echo ($order->order_amount+$order_detail->deliveryprice); ?> 
					</div>
					<br><br>
					<div>
