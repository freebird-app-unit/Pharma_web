			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div>
						...
						Order Assign to:&nbsp;&nbsp; <?php echo $order_detail->assign_date; ?><br><br>
						Order Pickup to:&nbsp;&nbsp; <?php echo $order_detail->pickup_date; ?><br><br>
						Delivered to:&nbsp;&nbsp; <?php echo $customer->name; ?><br><br>
						Order Delivered to:&nbsp;&nbsp; <?php echo $order_detail->deliver_date; ?><br><br>
						Delivered by:&nbsp;&nbsp; <?php echo $order_detail->deliveryboyname; ?><br><br>
					</div>
				</div>
			</div>
		</div>
