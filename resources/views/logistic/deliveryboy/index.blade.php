		...
		@endif
			<div class="table-rep-plugin">
				<div class="table-responsive" data-pattern="priority-columns">
					...
					<div class="col-sm-1">
						<a href="{{ route('logistic.deliveryboy.create') }}" class="btn btn-success waves-effect waves-light">Create</a>
					</div>
					<table id="admin_client_list" class="table  table-striped">
						<thead>
							<tr>
								...
								<th width="20%" data-priority="3">Email</th>
								<th width="20%" data-priority="4">Mobile number</th>
								<th width="20%" data-priority="5">No. Order assign</th>
