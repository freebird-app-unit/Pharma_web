			...
			<div class="table-rep-plugin">
				<div class="table-responsive" data-pattern="priority-columns">
					...
					<table id="admin_order_list" class="table  table-striped">
						<thead>
							<tr>
								<th width="10%" data-priority="1">First name</th>
								<th width="10%" data-priority="2">Last name</th>
								<th width="10%" data-priority="3">Address</th>
								<th width="10%" data-priority="4">Email</th>
								<th width="10%" data-priority="5">Phone</th>
								<th width="10%" data-priority="5">Date of application</th>
								<th width="10%" data-priority="5">Action</th>
							</tr>
						</thead>
						<tbody>
