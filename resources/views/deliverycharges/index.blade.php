...
<div class="row">
		<div class="col-lg-3 col-sm-6">
			<div class="widget-panel widget-style-2 bg-white">
				<h2 class="m-0 text-dark counter font-600" id='total_pending_order'><?php echo $total_order; ?></h2>
				<div class="text-muted m-t-5"><span id='total_title'>Total Order</span></div>
			</div>
		</div>
		<div class="col-lg-3 col-sm-6">
			<div class="widget-panel widget-style-2 bg-white">
				<h2 class="m-0 text-dark counter font-600" id='total_pending_amount'><?php echo $total_order_amount; ?></h2>
