...
<ul class="nav nav-tabs">
	...
	<li class="nav-item">
		<a href="{{ route('adminacceptedorders.index') }}" class="nav-link active">Accepted Orders</a>
	</li>
	<li class="nav-item">
				...
				<div class="table-responsive" data-pattern="priority-columns">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<button class="btn btn-info" onclick="return getacceptedorderslist(1);">Filter</button>
						</div><!-- input-group -->
					</div>
