						...
						<div class="panel-body">
							...
							<div class="col-sm-3">
								...
								<div class="input-group">
									<button class="btn btn-info" style='float: left;' onclick="getsellerreport(1)">Filter</button>
								</div>
							</div>
						</div>
					</div>
			<div class="table-rep-plugin">
				<div class="table-responsive" data-pattern="priority-columns">
					...
					<table id="admin_report_list" class="table  table-striped">
						<thead>
							<tr>
								<th width="10%" data-priority="1">Seller Name</th>
								<th width="30%" data-priority="2">Numbers Of Order successfully Completed</th>
								<th width="20%" data-priority="3">Numbers Of Order Rejected</th>
								<th width="30%" data-priority="4">Order Amount For Orders Succesfully Done</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
