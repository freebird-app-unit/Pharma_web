...
<ul class="nav nav-tabs">
	<li class="nav-item">
		<a href="{{ route('adminrejected.index') }}" class="nav-link active">Rejected Orders</a>
	</li>
	<li class="nav-item">
		<a href="{{ route('adminreturn.index') }}" class="nav-link">Return Orders</a>
	</li>
	<li class="nav-item">
		<a href="{{ route('admincancelled.index') }}" class="nav-link">Cancelled Orders</a>
	</li>
</ul>
<div class="row">
	<div class="col-sm-12">
					...
					<table id="admin_order_list" class="table  table-striped">
						<thead>
							<tr>
								...
								<th width="15%" data-priority="7">Reject By</th>
