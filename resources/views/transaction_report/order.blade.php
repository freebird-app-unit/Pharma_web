...
<div class="row">
		...
		<div class="col-lg-3 col-sm-6">
			<div class="widget-panel widget-style-2 bg-white">
				<h2 class="m-0 text-dark counter font-600" id='pending_collection'><?php echo $total_pending_collection; ?></h2>
				<div class="text-muted m-t-5"><span id='pending_collection_title'>Total Pending Collection</span></div>
			</div>
		</div>
		@endif
	<div class="col-sm-12">
					...
					<table id="admin_report_list" class="table  table-striped">
						<thead>
							<tr>
								...
								<th width="5%" data-priority="7"><button onclick="pay_pending()" class="btn btn-warning btn-custom waves-effect waves-light" title="Pay pending" data-toggle="modal" data-target="#pay_modal" id="pay" disabled>Pay</button></th>
							</tr>
						</thead>
						<tbody>
