...
class AcceptedordersController extends Controller
{
    ...
    public function index()
    {
		...
		$data['page_condition'] = 'page_acceptedorders';
        ...
        return view('acceptedorders.index', $data);
	}
	...
	public function getlist()
    {
		...
		if(count($order_detail)>0){
			...
			$pagination.='<li class="page-item '.$prev.'">
						<a class="page-link" onclick="getacceptedorderslist('.($page-1).')" href="javascript:;" tabindex="-1"> <i class="fa fa-angle-left"></i></a>
					</li>
					<li class="page-item '.$next.'">
						<a class="page-link" onclick="getacceptedorderslist('.($page+1).')" href="javascript:;"><i class="fa fa-angle-right"></i></a>
					</li>';
