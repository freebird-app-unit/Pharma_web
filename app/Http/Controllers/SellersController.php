...
class SellersController extends Controller
{
	...
	public function getlist()
    {
		...
		if(Auth::user()->user_type=='admin'){
			...
			$user_detail = new_pharma_logistic_employee::select('new_pharma_logistic_employee.*')->where('user_type','seller')->where('is_active',1)->where('pharma_logistic_id',$user_id);
		}
