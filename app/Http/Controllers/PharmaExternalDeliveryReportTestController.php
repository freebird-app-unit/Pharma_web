...
class PharmaExternalDeliveryReportTestController extends Controller{
    ...
    public function index()
    {
		...
		$data['page_condition'] = 'page_pharma_external_delivery_test_report';
        $data['site_title'] = 'External Delivery Report | ' . $this->data['site_title'];
        return view('pharma_external_delivery_report.index_test', $data);
    }
