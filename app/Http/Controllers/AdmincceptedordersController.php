...
class AdmincceptedordersController extends Controller
{
    ...
    public function index()
    {
		...
		$data['page_condition'] = 'page_adminacceptedorders';
		...
		$data['id'] = $user_id;
		return view('adminacceptedorders.index', $data);
	}
	public function getlist()
    {
		...
		if(count($order_detail)>0){
			...
			$pagination.='<li class="page-item '.$prev.'">
						<a class="page-link" onclick="getacceptedorderslist('.($page-1).')" style="'.$prev_disabled_style.'" href="javascript:;" tabindex="-1"> <i class="fa fa-angle-left"></i></a>
					</li>
					<li class="page-item '.$next.'">
						<a class="page-link" onclick="getacceptedorderslist('.($page+1).')" style="'.$next_disabled_style.'" href="javascript:;"><i class="fa fa-angle-right"></i></a>
					</li>';
